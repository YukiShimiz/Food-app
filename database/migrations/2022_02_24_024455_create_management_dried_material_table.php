...
class CreateManagementDriedMaterialTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('management_dried_material', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('management_dried_material');
    }
}
