...
class CreateMenuCarbohydratesBreadTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('menu_carbohydrates_bread', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('menu_carbohydrates_bread');
    }
}
