...
class CreateManagementTohunattopicklesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('management_tohunattopickles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('management_tohunattopickles');
    }
}
