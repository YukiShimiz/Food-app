...
class CreateMenuCarbohydratesNoodlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('menu_carbohydrates_noodles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('menu_carbohydrates_noodles');
    }
}
