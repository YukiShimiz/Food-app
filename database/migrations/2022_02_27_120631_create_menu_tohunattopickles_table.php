...
class CreateMenuTohunattopicklesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('menu_tohunattopickles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('menu_tohunattopickles');
    }
}
