...
class CreateTemplateDriedMaterialTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('template_dried_material', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('template_dried_material');
    }
}
