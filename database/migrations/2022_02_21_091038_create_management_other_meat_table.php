...
class CreateManagementOtherMeatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('management_other_meat', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('management_other_meat');
    }
}
