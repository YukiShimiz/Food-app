...
class CreateTemplateMarineProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('template_marine_products', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('template_marine_products');
    }
}
