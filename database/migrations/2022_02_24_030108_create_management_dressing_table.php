...
class CreateManagementDressingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('management_dressing', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('management_dressing');
    }
}
