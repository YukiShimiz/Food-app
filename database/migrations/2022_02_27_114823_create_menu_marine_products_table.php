...
class CreateMenuMarineProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('menu_marine_products', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('menu_marine_products');
    }
}
